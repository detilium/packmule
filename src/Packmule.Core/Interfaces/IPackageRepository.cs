...
public interface IPackageRepository
{
	...
	Task<Package> CreatePackageAsync(string packageName, CancellationToken cancellationToken = default);
	...
	Task<PackageVersion> CreatePackageVersionAsync(Guid packageId, string version, string manifestJson, string tarballUrl, string integrity, CancellationToken cancellationToken = default);
	...
	Task<DistTag> UpsertDistTagAsync(Guid packageId, string tag, string version, CancellationToken cancellationToken = default);
